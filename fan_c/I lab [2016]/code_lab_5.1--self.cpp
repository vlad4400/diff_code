			...
			switch (main_selected_item) {
				...
				case 4: {
					if (flag_case_1) {
						...
						record_to_file(matrix_a, len_row_A, len_column_A_row_B, "data_1.txt");
						record_to_file(matrix_b, len_column_A_row_B, len_column_B, "data_2.txt");
						record_to_file(matrix_c, len_row_A, len_column_B, "data_3.txt");
				...
				case 5: {
					...
					reading_file_data(matrix_a, len_row_A, len_column_A_row_B, "data_1.txt");
					reading_file_data(matrix_b, len_column_A_row_B, len_column_B, "data_2.txt");
					reading_file_data(matrix_c, len_row_A, len_column_B, "data_3.txt");

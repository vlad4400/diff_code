...
var
  chng, n2, clm, shw, sgn, i, j, k, v, vc, x, y, top, bot, left, right: byte;
  min, max: string;
  n1, chk, nn, d, h1, h2, res, iu, n1c, n: longint;
  //iu - iconic unit;
...
begin
  ...
  write('':x, '╔');
  for i := 1 to clm * 12 do
    if i mod 12 <> 0 then 
      write('═') 
    else if i <> clm * 12 then write('╤');
  write('╗');
  writeln;

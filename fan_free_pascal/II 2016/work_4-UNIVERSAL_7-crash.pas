...
var
  chng, clm, shw, n2, sgn, k, x, y, i, badrow, v: byte;
  min, max: string;
...
begin
  ...
  else badrow := trunc(d / chk);
  
  v := clm - (abs(trunc((nn-chk) / chk)) - badrow * clm);
  ...
  if clm > (nn - chk) / chk then clm := trunc((nn - chk) / chk);
  writeln((nn - chk)/chk);
    ...
    begin
      ...
      begin
        ...
        for  i := 1 to clm * 13 do 
          ...
          begin
            if (n1c - chk + badrow * clm * chk = n1) and (i div 13 > v) then
            begin
        ...
        if n1 = n1c - chk + badrow * clm * chk then writeln('╜')
        else writeln('╢');
      end;
    end;
  end;
  ...
  writeln(' n1c - chk + badrow * clm * chk: ', n1c - chk + badrow * clm * chk);}
